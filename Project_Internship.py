...
# create folder
os.makedirs("Python-for-automation-automate-tasks-excel-web-and-files/Internship Office Automation/letters", exist_ok=True)


try:
    data = pd.read_excel("Python-for-automation-automate-tasks-excel-web-and-files/Internship Office Automation/student_data/students.xlsx")

except FileNotFoundError:
    print("students.xlsx file not found")
    exit()
...
# ======================
    ...
    pdfmetrics.registerFont(TTFont("MAIAN", "Python-for-automation-automate-tasks-excel-web-and-files/Internship Office Automation/source_files/fonts/MAIAN.TTF"))
    
    safe_name = student["name"].replace(" ", "_")
    pdf_path = f"Python-for-automation-automate-tasks-excel-web-and-files/Internship Office Automation/letters/{safe_name}_vacation_training.pdf"
    ...
    logo = Image("Python-for-automation-automate-tasks-excel-web-and-files/Internship Office Automation/source_files/assets/logo/Logo.png", width=2*cm, height=2*cm)
    ...
    sig1 = Image("Python-for-automation-automate-tasks-excel-web-and-files/Internship Office Automation/source_files/assets/signatures/signature1.png", width=4*cm, height=2*cm)
    sig2 = Image("Python-for-automation-automate-tasks-excel-web-and-files/Internship Office Automation/source_files/assets/signatures/signature2.png", width=4*cm, height=2*cm)
...
students = pd.read_excel("Python-for-automation-automate-tasks-excel-web-and-files/Internship Office Automation/student_data/students.xlsx").to_dict(orient="records")
...
def load_students(filename = "Python-for-automation-automate-tasks-excel-web-and-files/Internship Office Automation/student_data/students.xlsx"):
    if os.path.exists(filename):
        students = pd.read_excel(filename)
        return students.to_dict(orient="records")  # list of dicts
    else:
...
print("Successfully Located and Extracted Data")
